...
\begin{enumerate}
    \item My name is Rohan. \rule{2cm}{0.4pt} am ten years old.
    \item That is Maya. Please give this book to \rule{2cm}{0.4pt}.
    \item The dog is hungry. Can you give \rule{2cm}{0.4pt} some food?
    \item My friends are here. \rule{2cm}{0.4pt} are waiting outside.
    \item Rohan and I are going to the park. Do you want to come with \rule{2cm}{0.4pt}?
\end{enumerate}
\end{activitybox}
